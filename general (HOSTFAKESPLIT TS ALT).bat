...
--lua-desync=hostfakesplit:host=www.google.com ^
--new ^
...
--out-range=-n4 ^
--payload=all ^
--lua-desync=fake:blob=tls_onetrust:tls_mod=rnd,dupsid,sni=www.google.com:repeats=8:tcp_ts=-600000:payload=all ^
