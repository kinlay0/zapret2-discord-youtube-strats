...
--payload=tls_client_hello ^
--lua-desync=fake:blob=tls_google:repeats=6:tcp_seq=2:tcp_ts=-600000:ip_id=zero ^
--new ^
...
--ipset-exclude="%LISTS%ipset-exclude-user.txt" ^
--payload=tls_client_hello ^
--lua-desync=fake:blob=stun:repeats=6:tcp_seq=2:tcp_ts=-600000 ^
--lua-desync=fake:blob=tls_google:repeats=6:tcp_seq=2:tcp_ts=-600000 ^
--payload=http_req ^
--lua-desync=fake:blob=tls_onetrust:repeats=6:tcp_seq=2:tcp_ts=-600000 ^
--new ^
...
--lua-desync=fake:blob=stun:repeats=6:tcp_seq=2:tcp_ts=-600000:payload=tls_client_hello,unknown ^
--lua-desync=fake:blob=tls_google:repeats=6:tcp_seq=2:tcp_ts=-600000:payload=tls_client_hello,unknown ^
--payload=http_req ^
--lua-desync=fake:blob=tls_onetrust:repeats=6:tcp_seq=2:tcp_ts=-600000 ^
--new ^
