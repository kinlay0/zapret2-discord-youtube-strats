...
--payload=tls_client_hello ^
--lua-desync=fakedsplit:pos=2:repeats=8:tcp_seq=2:ip_id=zero ^
--new ^
...
--lua-desync=fakedsplit:pos=2:repeats=8:tcp_seq=2 ^
--payload=http_req ^
--lua-desync=fake:blob=tls_onetrust:repeats=8:tcp_seq=2 ^
--lua-desync=fakedsplit:pos=2:repeats=8:tcp_seq=2 ^
--new ^
...
--lua-desync=fake:blob=tls_onetrust:repeats=8:tcp_seq=2:payload=tls_client_hello,unknown ^
--lua-desync=fakedsplit:pos=2:repeats=8:tcp_seq=2:payload=tls_client_hello,unknown ^
--payload=http_req ^
--lua-desync=fake:blob=tls_onetrust:repeats=8:tcp_seq=2 ^
--lua-desync=fakedsplit:pos=2:repeats=8:tcp_seq=2 ^
--new ^
