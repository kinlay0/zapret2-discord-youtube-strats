...
--wf-tcp-in=80,443,853,2053,2083,2087,2096,8443,%GameFilterTCP% --wf-udp-in=443,19294-19344,50000-50100,%GameFilterUDP% ^
--wf-tcp-out=80,443,853,2053,2083,2087,2096,8443,%GameFilterTCP% --wf-udp-out=443,19294-19344,50000-50100,%GameFilterUDP% ^
...
--payload=tls_client_hello ^
--lua-desync=fake:blob=tls_google:tls_mod=rnd,dupsid:repeats=6:tcp_ts=-600000 ^
--lua-desync=multidisorder:pos=1,sniext+1,host+1,midsld-2,midsld,midsld+2,endhost-1 ^
--new ^

--name="domain tls" ^
--filter-tcp=80,443,853 ^
--hostlist="%LISTS%list-general.txt" ^
--hostlist="%LISTS%list-general-user.txt" ^
--hostlist-exclude="%LISTS%list-exclude.txt" ^
--hostlist-exclude="%LISTS%list-exclude-user.txt" ^
...
--ipset-exclude="%LISTS%ipset-exclude-user.txt" ^
--payload=tls_client_hello ^
--lua-desync=fake:blob=tls_google:tls_mod=rnd:repeats=4:badsum ^
--lua-desync=fake:blob=tls_5ka:tls_mod=rnd,dupsid,sni=5ka.ru:repeats=6:tcp_ts=-600000 ^
--lua-desync=multisplit:pos=midsld:seqovl=664:seqovl_pattern=tls_onetrust ^
--payload=http_req ^
--lua-desync=fake:blob=tls_onetrust:repeats=6:tcp_ts=-600000 ^
--lua-desync=multisplit:pos=midsld:seqovl=1 ^
--new ^
...
--ipset-exclude="%LISTS%ipset-exclude-user.txt" ^
--payload=tls_client_hello ^
--lua-desync=fake:blob=tls_mail:tls_mod=rnd,dupsid,sni=appstorrent.ru:repeats=6:tcp_ts=-600000 ^
--payload=http_req ^
--lua-desync=fake:blob=tls_mail:repeats=6:tcp_ts=-600000 ^
--new ^
