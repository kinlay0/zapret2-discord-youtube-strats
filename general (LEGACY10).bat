...
--payload=tls_client_hello ^
--lua-desync=fake:blob=tls_google:repeats=6:tcp_ts=-600000:ip_id=zero ^
--new ^
...
--ipset-exclude="%LISTS%ipset-exclude-user.txt" ^
--payload=tls_client_hello ^
--lua-desync=fake:blob=tls_4pda:repeats=6:tcp_ts=-600000 ^
--payload=http_req ^
...
--ipset-exclude="%LISTS%ipset-exclude-user.txt" ^
--payload=tls_client_hello ^
--lua-desync=fake:blob=tls_google:tls_mod=rnd,sni=www.google.com:repeats=6:tcp_ts=-600000 ^
--lua-desync=fake:blob=tls_4pda:repeats=6:tcp_ts=-600000 ^
--payload=http_req ^
--lua-desync=fake:blob=tls_onetrust:repeats=6:tcp_ts=-600000 ^
--new ^
...
--lua-desync=fake:blob=tls_google:tls_mod=rnd,sni=www.google.com:repeats=6:tcp_ts=-600000:payload=tls_client_hello,unknown ^
--lua-desync=fake:blob=tls_4pda:repeats=6:tcp_ts=-600000:payload=tls_client_hello,unknown ^
--payload=http_req ^
--lua-desync=fake:blob=tls_onetrust:repeats=6:tcp_ts=-600000 ^
--new ^
